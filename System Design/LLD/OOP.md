...
- **Method/Function Overloading:** Use single method name for similar operations (reduces redundancy)
- **Operator Overloading**

##### Dynamic / Run-Time Polymorphism
- **Method Overriding:** Enables dynamic method resolution
- **Dynamic Binding:** Code execution decided at **runtime** in response to function call
...
| Principle | Purpose |
|-----------|---------|
| **Encapsulation** | Protect data integrity through access control |
| **Abstraction** | Hide complexity, show only essentials |
| **Inheritance** | Promote code reusability through hierarchy |
| **Polymorphism** | Enable flexible, context-based behavior |

These four principles form the foundation of effective object-oriented design.